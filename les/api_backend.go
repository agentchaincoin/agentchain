...
func (b *LesApiBackend) SendPrivateTx(ctx context.Context, signedTx *types.Transaction) error {
	return errors.New("private transactions not supported on light clients")
}
...
func (b *LesApiBackend) StartMining(threads int) error {
	return errors.New("mining not supported on light client")
}

func (b *LesApiBackend) StopMining() {
}

func (b *LesApiBackend) SetEtherbase(etherbase common.Address) {
}
