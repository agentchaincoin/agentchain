...
// gossipDelay is the time to wait before broadcasting new transactions to peers.
// This gives the local miner time to include transactions in a block before
// they are visible to the rest of the network, reducing MEV frontrunning.
const gossipDelay = 2 * time.Second
